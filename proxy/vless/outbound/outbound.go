...
import (
	...
	"time"
	"unsafe"
	"strconv" // اضافه شدن برای تبدیل پورت
	...
	"github.com/F4RD1N/xray-core/common/retry"
	"github.com/F4RD1N/xray-core/common/session"
	"github.com/F4RD1N/xray-core/common/signal"
	"github.com/F4RD1N/xray-core/common/task"
	"github.com/F4RD1N/xray-core/common/xudp"
	"github.com/F4RD1N/xray-core/core"
	"github.com/F4RD1N/xray-core/features/policy"
	"github.com/F4RD1N/xray-core/proxy"
	"github.com/F4RD1N/xray-core/proxy/vless"
	"github.com/F4RD1N/xray-core/proxy/vless/encoding"
...
func (h *Handler) Process(ctx context.Context, link *transport.Link, dialer internet.Dialer) error {
	...
	// --- تغییر مهم برای حفظ پورت فیک روی رم ---
	var dialDest net.Destination 
	
	if err := retry.ExponentialBackoff(5, 200).On(func() error {
		rec = h.serverPicker.PickServer()
		
		// یک کپی از مقصد می‌گیریم و پورتش رو برای اتصال تغییر می‌دیم
		dialDest = rec.Destination()
		dialDest.Port = restorePort(dialDest.Port)
		
		var err error
		conn, err = dialer.Dial(ctx, dialDest) // استفاده از dialDest جایگزین rec.Destination()
		if err != nil {
			return err
		}
		return nil
	...
	// در لاگ هم پورت واقعی متصل شده رو نشون می‌دیم
	errors.LogInfo(ctx, "tunneling request to ", target, " via ", dialDest.NetAddr())
